...
4. [版本功能需求](Versions/README.md)：查看 1.0.0、1.1.0 和 1.2.0 的产品范围与验收条件。
...
| 版本 | [`Versions/`](Versions/README.md) | 1.0.0、1.1.0 与 1.2.0 功能需求 |
...
- [`PRIVACY_POLICY_v1.2.0.md`](PRIVACY_POLICY_v1.2.0.md)：1.2.0 隐私政策，包含 DS Audio 和 Google Drive 在线源边界。
